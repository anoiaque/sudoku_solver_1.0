...
class SudokuTester < Test::Unit::TestCase
  ...
  @@sudokus_file = File.open(File.join(File.dirname(__FILE__),'sudokus_lth_level_88'))
  @@solutions_file = File.open(File.join(File.dirname(__FILE__),'sudokus_lth_level_88_solved'))
  ...
  def test_easy_and_intermediate_sudokus
